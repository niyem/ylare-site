...
A clean, modern academic website for Prof. Yendoubé Lare (Université de Lomé), built as static HTML/CSS for hosting on GitHub Pages with a custom subdomain (`ylare.groupebm.net`).
...
3. The `CNAME` file already sets the custom domain to `ylare.groupebm.net`
